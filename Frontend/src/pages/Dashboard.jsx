...
function Dashboard() {
  ...
  const stats = [
    ...
    { title: t('dashboard.activeRoutes'), value: '8', icon: '🗺️', color: 'bg-green-500' },
    { title: t('dashboard.vehicles'), value: '12', icon: '🚛', color: 'bg-purple-500' },
    { title: t('dashboard.deliveriesToday'), value: '15', icon: '✅', color: 'bg-orange-500' },
  ];
        ...
        <main className="p-4 sm:p-6 lg:p-8">
          ...
          <div className={`rounded-xl shadow-lg border p-6 transition-all duration-300 ${
            ...
            <div className="space-y-4">
              <div className={`flex items-center justify-between p-4 rounded-lg transition-all duration-200 hover:scale-[1.02] ${
