...
function NotFound() {
  ...
  React.useEffect(() => {
    showLoaderWithText("Loading...", 1500);
  }, [showLoaderWithText]);
    ...
    >
      <div className="text-center px-4 py-8 max-w-2xl mx-auto">
        ...
        <div className="mb-8 relative">
          ...
          <h1
            className={`text-9xl font-bold mb-4 transition-colors ${
        ...
        {/* Content */}
        <div
          className={`mb-8 p-8 rounded-2xl shadow-xl transition-all duration-300 ${
            isDark
