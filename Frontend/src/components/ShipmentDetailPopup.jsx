            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    {shipment.receiver_email || t("common.notAvailable")}
                  </p>
                </div>
                <div>
                  <p
                  ...
                  >
                    {shipment.receiver_address || t("common.notAvailable")}
                  </p>
                </div>
              </div>
            </div>
